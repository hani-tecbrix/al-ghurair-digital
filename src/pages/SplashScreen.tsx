...
const SplashScreen = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#003D31] via-[#002822] to-[#001A15] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10 animate-fade-in">
        <div className="mb-8 animate-scale-in">
          <div className="w-32 h-32 mx-auto mb-6 bg-white rounded-3xl shadow-2xl flex items-center justify-center transform hover:scale-105 transition-transform duration-300">
            <img 
          ...
          <h1 className="text-white text-4xl font-bold mb-3 tracking-tight">Al Ghurair</h1>
          <p className="text-[#F0FF3D] text-xl font-semibold tracking-wide">Exchange</p>
        </div>
